      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto leading-relaxed">
            Watch below to find out how to use AI to bring in <span className="font-semibold text-neutral-900 dark:text-white">25% more patients</span> in as soon as <span className="font-semibold text-sky-500">14 days</span>
          </p>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-white mb-6 leading-tight">
              Try Out Our AI Patient Coordinator
            </h2>
