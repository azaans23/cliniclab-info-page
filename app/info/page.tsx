    ...
    <div className="min-h-screen bg-neutral-950 relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 sm:py-16 lg:py-24">
        ...
        <div className="text-center mb-8 sm:mb-16">
          <div className="mb-6">
            <p className="text-sm sm:text-base uppercase tracking-wider text-neutral-500 text-neutral-400 mb-3 font-semibold">
              Established Dental Practice Owners
            </p>
            <h1 className="text-2xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-neutral-900 text-white mb-4 leading-tight">
              Tired of Losing Patients to Voicemail and Ineffective Follow-up?
            </h1>
          </div>
          <p className="text-lg sm:text-xl text-neutral-600 text-neutral-400 max-w-3xl mx-auto leading-relaxed">
            Watch below to find out how our system is bringing in 15 to 25 more patients in as soon as 30 days
          </p>
        </div>
        ...
        {/* Divider */}
        <div className="mb-8 sm:mb-16 border-t border-neutral-200 border-neutral-800"></div>

        {/* Call to Action */}
        <div className="mb-8 sm:mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 text-white mb-6 leading-tight">
              Try Out Our <span className="text-sky-500">Human AI</span> — At Any Time
            </h2>
            ...
            <a 
              ...
              className="inline-flex items-center gap-4 text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-400 hover:text-blue-300 transition-colors group"
            >
          ...
          <div className="mt-12" id="booking-form">
            <p className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-neutral-900 text-white mb-4 sm:mb-6 text-center">
              ...
              <CardContent className="pt-6">
                <div className="flex flex-col sm:flex-row gap-6">
                  <div className="flex-shrink-0 w-full sm:w-80 cursor-pointer" onClick={() => setSelectedTestimonial({ videoUrl: testimonial.videoUrl, author: testimonial.author })}>
                    <div className="relative aspect-video bg-neutral-100 bg-neutral-800 rounded-lg overflow-hidden group hover:opacity-90 transition-opacity">
            ...
            {[
              {
                ...
                answer: "Yes. Clinic Lab AI integrates with many leading EHR and practice management platforms, enabling it to schedule, reschedule, and cancel appointments directly within your calendar. If your system has restrictions on patient or appointment modifications, we will review compatibility and available workarounds during your AI strategy call.",
              },
              {
                question: "What happens if a patient asks something the AI can't answer?",
                answer: "When an inquiry requires clinical judgment or involves complex billing or insurance matters, Clinic Lab AI can transfer the call to your front office and escalate the request to your team via email to ensure timely follow-up and continuity of care.",
              },
              {
                question: "Can the AI handle both inbound and outbound calls?",
                answer: "Yes. Clinic Lab AI answers inbound calls 24/7 and can also place outbound calls for lead follow-up, callback requests, appointment confirmations, unscheduled treatment plan reminders, and patient reactivation initiatives.",
              },
              {
                question: "How long does it take to set up and go live?",
                answer: "In most cases, Clinic Lab AI can be implemented within approximately thirty days of onboarding. The system is configured to your practice and integrated so it can begin handling calls, scheduling appointments, and supporting patient communications promptly upon launch.",
              },
              {
                question: "Is there training required for my staff?",
                answer: "Minimal ongoing involvement is required. Beyond completing an initial customization form and a brief onboarding overview, Clinic Lab AI operates in the background, reducing front-desk interruptions and allowing staff to focus on in-office patient needs.",
              },
              {
                question: "Is the AI HIPAA compliant?",
                answer: "Yes. Clinic Lab AI is designed to support HIPAA compliance through strong security controls and encryption measures intended to safeguard patient data and communications.",
              },
            ].map((faq, index) => {
                ...
                >
                  ...
                  >
                    <CardContent className="pt-6 pb-2.5 px-6">
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <svg
                          className={`w-5 h-5 text-neutral-500 text-neutral-400 flex-shrink-0 transition-transform duration-200 ${
                            isOpen ? "rotate-180" : ""
                          }`}
                          fill="none"
                          stroke="currentColor"
                  ...
                  >
                    <div className="px-6 pt-4 pb-4 border-t border-neutral-200 border-neutral-800 mt-2">
                      <p className="text-base sm:text-lg text-neutral-700 text-neutral-300 leading-relaxed">
                        {faq.answer}
                      </p>
                    </div>
                  </div>
        ...
        <div className="mb-8 sm:mb-16 text-center">
          <button
            ...
            className="px-8 py-4 bg-sky-500 hover:bg-sky-600 text-white font-bold text-lg sm:text-xl rounded-lg transition-colors shadow-lg hover:shadow-xl"
          >
            <span className="hidden sm:inline">Click here to stop missing patients forever</span>
            <span className="sm:hidden">Tap here to stop missing patients forever</span>
          </button>
        </div>
